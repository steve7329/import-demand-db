...
base_url = 'mysql+pymysql://admin:dhgkqwlwhf5@import-demand-db.cqr8wgqy24po.us-east-1.rds.amazonaws.com:3306/'
base_engine = create_engine(base_url, connect_args={'ssl': {'ca': './global-bundle.pem'}})

with base_engine.connect() as conn:
    conn.execute(text("CREATE DATABASE IF NOT EXISTS gdp_db;"))

db_connection_url = 'mysql+pymysql://admin:dhgkqwlwhf5@import-demand-db.cqr8wgqy24po.us-east-1.rds.amazonaws.com:3306/gdp_db'
